...
ln -sfn "$(pwd)/dist" ~/.n8n/custom/n8n-nodes-stream-file
```
...
- Check that the symlink exists: `ls -la ~/.n8n/custom/n8n-nodes-stream-file`
- Verify the dist folder has the node: `ls -la ~/.n8n/custom/n8n-nodes-stream-file/nodes/`
